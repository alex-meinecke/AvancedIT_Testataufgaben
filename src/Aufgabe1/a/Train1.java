...
public class Train1 extends TrainDraftForExerciseA {
    public Train1(Semaphore mutexOfSharedTrack, Semaphore availablePassesForThisTrain, Semaphore availablePassesForPartnerTrain) {
        super(1,availablePassesForThisTrain,availablePassesForPartnerTrain, mutexOfSharedTrack);
    }
